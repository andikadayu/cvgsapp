...
public class ProfileActivity extends AppCompatActivity {
    ...
    Button btnToLogin, btnToAbout, btnLogout, btnAdminGoBrosur, btnPendaftarAdm, btnPendaftarSuper, btnPembayaranAdm, btnPembayaranSuper, btnUserTransaksi, btnProgressSuper, btnProgressAdm, btnProgressUser, btnBroadcastSuper, btnBroadcastAdm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnProgressAdm = findViewById(R.id.btnProgressAdm);
        ...
        btnProgressAdm.setOnClickListener(view -> startActivity(new Intent(getApplicationContext(), ProgressAdminActivity.class)));
